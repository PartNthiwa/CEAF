...
<div class="w-full bg-purple-600 border-b relative">
 ...
 <div class="absolute left-0 mt-1 w-60 bg-white shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-200 z-50">
  ...
  <a href="/donate" class="bg-purple-600 text-white px-5 py-2 rounded-md font-semibold hover:bg-purple-700 transition">Donate</a>
   ...
   <!-- ================= Bereaved Parents ================= -->
<section id="bereaved-parents" class="py-24 bg-gray-50">
  <div class="max-w-7xl mx-auto px-6">
    <!-- Header Image -->
    <div class="mb-12 text-center">
      <img  
          src="{{ asset('images/grieving-parents.jpg') }}" 
          alt="Bereaved parents" 
    ...
    <div class="bg-purple-50 border-l-4 border-purple-600 p-6 rounded-xl mb-12 shadow-md">
      @if(auth()->check() && auth()->user()->is_member)
        <p class="text-gray-700 mb-4">
          Access programs and support networks tailored for bereaved parents, including workshops, counseling sessions, and guides.
        </p>
        <ul class="list-disc pl-6 text-gray-700 space-y-1 mb-4">
          <li>One-on-one counseling sessions</li>
          <li>Peer support groups for grieving parents</li>
          <li>Guides on coping strategies and memorial planning</li>
        </ul>
        <a href="/events/register?category=parents" class="bg-purple-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-purple-700 transition">
          Register for Parent Support Session
        </a>
      @else
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        ...
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Your Grief</h3>
        <p class="text-gray-700">The early days are unimaginable. Emotions may fluctuate for years. Seek support from fellow parents or professionals to help navigate your grief.</p>
      </div>

      <!-- Tip 2 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">2</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Your Relationships</h3>
        <p class="text-gray-700">Loss can affect relationships with family and friends. Lean on those who understand and be patient with those unsure how to help.</p>
      </div>

      <!-- Tip 3 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">3</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Your Other Children</h3>
        <p class="text-gray-700">If you have surviving children, support their grief as well. Open communication and age-appropriate guidance are vital.</p>
      </div>

      <!-- Tip 4 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">4</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Loss of an Only Child or All Children</h3>
        <p class="text-gray-700">Parents who lost their only child or all children face profound challenges. Support groups and counseling can help mitigate isolation.</p>
      </div>

      <!-- Tip 5 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">5</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Self-Compassion</h3>
        <p class="text-gray-700">Care for yourself with rest, proper meals, and reflection. Allow yourself to feel, cry, and heal at your own pace.</p>
      </div>

      <!-- Tip 6 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">6</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Seek Support</h3>
        <p class="text-gray-700">Professional guidance, support groups, and peer communities provide comfort, validation, and connection.</p>
      </div>
    </div>

    <!-- Closing CTA -->
    <div class="mt-12 text-center text-purple-600 rounded-lg bg-yellow-400 text-lg p-6">
      <p>Grief transforms who you are, but through patience, support, and self-compassion, you can continue to honor your child while finding ways to live fully again.</p>
    </div>
  </div>
</section>
