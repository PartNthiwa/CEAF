...
<section id="bereaved-spouses" class="py-24 bg-gray-50">
  <div class="max-w-7xl mx-auto px-6">
    <!-- Header Image -->
    <div class="mb-12 text-center">
      <img  
          src="{{ asset('images/grieving-spouses.jpg') }}" 
          alt="Bereaved spouses" 
    ...
    <div class="bg-purple-50 border-l-4 border-purple-600 p-6 rounded-xl mb-12 shadow-md">
      @if(auth()->check() && auth()->user()->is_member)
        <p class="text-gray-700 mb-4">
          Access workshops, peer support, counseling, and resources designed specifically for bereaved spouses.
        </p>
        <ul class="list-disc pl-6 text-gray-700 space-y-1 mb-4">
          <li>Counseling for grieving spouses</li>
          <li>Support circles and peer mentorship</li>
          <li>Guidance on coping strategies and moving forward</li>
        </ul>
        <a href="/events/register?category=spouses" class="bg-purple-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-purple-700 transition">
          Register for Spouse Support Session
        </a>
      @else
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        ...
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Allow Yourself to Grieve</h3>
        <p class="text-gray-700">Grief is natural and personal. Don’t rush it or hide your emotions. Feeling sadness, anger, or guilt is part of healing.</p>
      </div>

      <!-- Tip 2 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">2</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Take Care of Your Health</h3>
        <p class="text-gray-700">Physical well-being supports emotional healing. Eat balanced meals, rest adequately, and engage in gentle exercise.</p>
      </div>
      ...
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        ...
        <p class="text-gray-700">Reach out to friends or family who understand your loss. Sharing memories or talking about your spouse can provide comfort.</p>
      </div>

      <!-- Tip 4 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">4</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Join Support Groups</h3>
        <p class="text-gray-700">Connecting with other bereaved spouses helps reduce isolation and provides shared coping strategies.</p>
      </div>

      <!-- Tip 5 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">5</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Be Patient with Yourself</h3>
        <p class="text-gray-700">Grief doesn’t follow a set timeline. Allow yourself the time and space to heal at your own pace.</p>
      </div>

      <!-- Tip 6 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">6</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Stay Socially Engaged</h3>
        <p class="text-gray-700">Combat loneliness by participating in social circles, volunteering, or community activities. Small connections help rebuild belonging.</p>
      </div>

      <!-- Tip 7 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">7</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Consider Professional Help</h3>
        <p class="text-gray-700">If grief feels overwhelming or prevents daily functioning, a therapist or grief counselor can provide coping strategies tailored to you.</p>
      </div>
      ...
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        ...
        <p class="text-gray-700">Keep your spouse’s memory alive through rituals, storytelling, or personal keepsakes. Remembering them can provide comfort.</p>
      </div>
    </div>

    <!-- Closing CTA -->
    <div class="mt-12 text-center text-purple-600 rounded-lg bg-yellow-400 text-lg p-6">
      <p>Remember: Grief is personal. Honor your emotions, seek support, and allow yourself time to adjust. Healing is gradual, but it’s possible to rebuild life while cherishing your spouse’s memory.</p>
    </div>
  </div>
</section>
