...
<section id="donate" class="w-full bg-blue-600 py-24">
  <div class="max-w-7xl mx-auto px-6 text-center text-white">
    ...
    <p class="text-lg md:text-xl mb-16 max-w-3xl mx-auto text-white/90">
      Your donation helps us continue our mission of empowering communities across East Africa with education, healthcare, and economic opportunities. Every contribution counts!
    </p>

    <!-- Donation Form or Success Message -->
    @if(session('donation_success'))
      <!-- Success Message -->
      <div class="bg-green-600 p-8 rounded-lg shadow-lg text-white max-w-lg mx-auto">
        <h3 class="text-2xl font-bold mb-6">Thank You for Your Donation!</h3>
        <p class="mb-4">Your generosity is helping create a brighter future for communities in East Africa.</p>
        <p class="text-sm mb-4">Transaction ID: {{ session('donation_transaction_id') }}</p>
        <p class="text-sm mb-4">Amount: ${{ session('donation_amount') }}</p>
        <a href="/" class="bg-yellow-400 text-purple-700 px-6 py-3 rounded-lg font-semibold hover:bg-yellow-300">
          Return to Homepage
        </a>
      </div>
    @else
      ...
      <div class="bg-white p-8 rounded-lg shadow-lg text-purple-700 max-w-lg mx-auto">
        <h3 class="text-2xl font-bold mb-6">Donate Now</h3>
        ...
        <form action="{{ route('donation.process') }}" method="POST" class="space-y-6">
          ...
          <!-- Name Input -->
          <div>
            <label for="name" class="block text-sm font-medium text-purple-700">Your Name</label>
            <input
              type="text"
              id="name"
              name="name"
          ...
          <!-- Email Input -->
          <div>
            <label for="email" class="block text-sm font-medium text-purple-700">Your Email</label>
            <input
              type="email"
              id="email"
              name="email"
          ...
          <!-- Donation Amount -->
          <div>
            <label for="amount" class="block text-sm font-medium text-purple-700">Donation Amount</label>
            <input
              type="number"
              id="amount"
              name="amount"
    ...
    <!-- Additional Text -->
    <p class="text-xs md:text-md font-semibold mt-8 text-white/90">
      Thank you for supporting the Carolina East Africa Foundation. Your generosity is changing lives!
    </p>
  </div>
</section>
