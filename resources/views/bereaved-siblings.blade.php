...
<section id="bereaved-siblings" class="py-24 bg-gray-50">
  <div class="max-w-7xl mx-auto px-6">
    <!-- Header Image -->
    <div class="mb-12 text-center">
      <img  
          src="{{ asset('images/grieving-siblings.jpg') }}" 
          alt="Bereaved siblings" 
    ...
    <div class="bg-purple-50 border-l-4 border-purple-600 p-6 rounded-xl mb-12 shadow-md">
      @if(auth()->check() && auth()->user()->is_member)
        <p class="text-gray-700 mb-4">
          Access programs and support networks tailored for bereaved siblings, including workshops, counseling sessions, and guides.
        </p>
        <ul class="list-disc pl-6 text-gray-700 space-y-1 mb-4">
          <li>Support groups for siblings of different age ranges</li>
          <li>Guides on coping with sibling loss</li>
          <li>Counseling sessions available for emotional support</li>
        </ul>
        <a href="/events/register?category=siblings" class="bg-purple-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-purple-700 transition">
          Register for Sibling Support Session
        </a>
      @else
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        ...
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Acknowledge Your Loss</h3>
        <p class="text-gray-700">Recognize that losing a sibling can be deeply emotional. Allow yourself to feel sadness, anger, or confusion without judgment.</p>
      </div>

      <!-- Tip 2 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">2</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Share Memories</h3>
        <p class="text-gray-700">Talk about your sibling with family or friends, recall happy moments, or write down your memories. Remembering them can bring comfort and connection.</p>
      </div>

      <!-- Tip 3 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">3</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Express Your Emotions</h3>
        <p class="text-gray-700">Don’t bottle up feelings. Cry, journal, or talk to someone you trust. Expressing emotions helps process grief effectively.</p>
      </div>

      <!-- Tip 4 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">4</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Seek Support from Loved Ones</h3>
        <p class="text-gray-700">Lean on family or friends who understand your relationship with your sibling. Talking to those who knew them can provide comfort and shared understanding.</p>
      </div>

      <!-- Tip 5 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">5</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Honor Their Memory</h3>
        <p class="text-gray-700">Create rituals, like lighting a candle, making a memory scrapbook, or celebrating their birthday, to keep their memory alive.</p>
      </div>
      ...
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        ...
        <p class="text-gray-700">Grief affects your physical and emotional health. Eat well, rest, and engage in activities that nourish your mind and body.</p>
      </div>

      <!-- Tip 7 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">7</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Be Patient with Your Grief</h3>
        <p class="text-gray-700">Grief has no set timeline. Some days may feel manageable, others difficult. Allow yourself time to heal and don’t rush the process.</p>
      </div>

      <!-- Tip 8 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">8</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Consider Professional Support</h3>
        <p class="text-gray-700">If grief becomes overwhelming or impacts daily life, a therapist or grief counselor can provide guidance and coping strategies tailored to your experience.</p>
      </div>
    </div>

    <!-- Closing CTA -->
    <div class="mt-12 text-center text-purple-600 rounded-lg bg-yellow-400 text-lg p-6">
      <p>Remember: The bond between siblings is unique. Allow yourself to grieve, reach out for support, and find ways to honor your sibling’s memory. Healing is a journey that takes time and care.</p>
    </div>
  </div>
</section>
