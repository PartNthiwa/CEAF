...
<section id="invite-required" class="w-full bg-blue-600 py-24">
    <div class="max-w-7xl mx-auto px-6 text-center text-white">
        ...
        <p class="text-lg md:text-xl mb-16 max-w-3xl mx-auto text-white/90">
            Registration to the Carolina East Africa Foundation portal is by invitation only.
            Please contact the administrator for assistance.
        </p>

        <!-- Message Card -->
        <div class="bg-white p-8 rounded-lg shadow-lg text-purple-700 max-w-2lg mx-auto">
            <h3 class="text-2xl font-bold mb-4">Need Access?</h3>

            <p class="text-gray-700 mb-6">
                To become a registered member, you must receive an official invitation from the foundation.
                This helps us maintain the integrity and security of our bereavement registry.
            </p>
            ...
            <div class="text-sm text-gray-600 space-y-2">
                ...
                <p>
                    📞 Phone:
                    <strong class="text-purple-800">+254 700 000 000</strong>
                </p>
            </div>

           <div class="mt-6 space-y-4">
                <p class="text-sm text-gray-600">
                    Already a member of the Carolina East Africa Foundation?
                </p>

                <a href="{{ route('login') }}"
                class="inline-block bg-yellow-400 text-purple-700 px-6 py-3 rounded-lg font-semibold hover:bg-yellow-300 transition">
                    Login to Your Account
                </a>

                <p class="text-xs text-gray-500">
                    New members must receive an invitation from the administrator before registering.
                    Please contact the foundation office for support.
                </p>
            </div>
