...
<div class="w-full bg-purple-600 border-b relative">
  ...
  <a href="/donate" class="bg-purple-600 text-white px-5 py-2 rounded-md font-semibold hover:bg-purple-700 transition">Donate</a>
      ...
      <!-- Mobile menu toggle using checkbox -->
        ...
        <!-- ================= CONTACT US ================= -->
<section id="bereavement" class="py-24 bg-gray-50">
  <div class="max-w-7xl mx-auto px-6 text-center">
    ...
    <p class="text-gray-700 text-lg md:text-xl mb-6">
      Our services provide guidance and support for those who have lost loved ones. 
    </p>

    <!-- Notice for non-members -->
    <div class="bg-yellow-100 text-yellow-800 border border-yellow-300 rounded-lg p-4 mb-12 max-w-2xl mx-auto">
      <p class="font-semibold">
        Please note: Bereavement support services are available <strong>only to registered members</strong> of the Carolina East Africa Foundation.
      </p>
      <p class="mt-2">
        Not a member yet? <a href="/register" class="text-purple-600 font-semibold underline hover:text-purple-700">Register here</a> to gain full access.
      </p>
    </div>

    <p class="text-gray-700 text-lg md:text-xl mb-12">
      Choose the category that fits your situation.
    </p>

    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
    <a href="/bereaved-children" class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <h2 class="text-xl font-semibold text-purple-600 mb-2">Bereaved Child</h2>
        <p class="text-gray-700">Support programs tailored for children coping with loss.</p>
    </a>

    <a href="/bereaved-parents" class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <h2 class="text-xl font-semibold text-purple-600 mb-2">Bereaved Parent</h2>
        <p class="text-gray-700">Guidance and counseling for parents who have lost a child.</p>
    </a>

    <a href="/bereaved-siblings" class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <h2 class="text-xl font-semibold text-purple-600 mb-2">Bereaved Sibling</h2>
        <p class="text-gray-700">Resources to help siblings navigate grief and loss.</p>
    </a>

    <a href="/bereaved-spouses" class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <h2 class="text-xl font-semibold text-purple-600 mb-2">Bereaved Spouse</h2>
        <p class="text-gray-700">Support networks for spouses dealing with bereavement.</p>
    </a>

    <a href="/what-to-do" class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <h2 class="text-xl font-semibold text-purple-600 mb-2">What to Do & Expect</h2>
        <p class="text-gray-700">Step-by-step guidance for coping with loss and attending memorials.</p>
    </a>
    </div>
