...
<div class="w-full bg-purple-600 border-b relative">
 ...
 <!-- =================     Bereaved children ================= -->
<section id="bereaved-children" class="py-24 bg-gray-50">
  <div class="max-w-7xl mx-auto px-6">
    <!-- Header -->
      <div class="mb-12 text-center">
  <img  
      src="{{ asset('images/grieving-child.jpg') }}" 
      alt="Grieving child" 
  ...
  <p class="text-gray-700 mt-4 italic">
    ...
    <div class="text-center mb-12">
      <h1 class="text-4xl md:text-5xl font-extrabold text-purple-600 mb-2">
        Bereaved Children
      </h1>
      <span class="block mt-2 w-20 h-1 bg-yellow-400 rounded-full mx-auto"></span>
      <p class="mt-4 text-gray-700 text-lg md:text-xl max-w-3xl mx-auto">
    ...
    <div class="bg-purple-50 border-l-4 border-purple-600 p-6 rounded-xl mb-12 shadow-md">
      @if(auth()->check() && auth()->user()->is_member)
        <p class="text-gray-700 mb-4">
          Access programs tailored for children, including workshops, counseling sessions, and guides.
        </p>
        <ul class="list-disc pl-6 text-gray-700 space-y-1 mb-4">
          <li>Age-appropriate grief counseling sessions</li>
          <li>Support groups for children</li>
          <li>Guidance for parents</li>
          <li>Educational materials and coping guides</li>
        </ul>
        <a href="/events/register?category=children" class="bg-purple-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-purple-700 transition">
          Register for Child Support Session
        </a>
      @else
        <div class="bg-yellow-100 text-yellow-800 border border-yellow-300 rounded-lg p-6">
          <p class="font-semibold">Bereavement support services are available <strong>only to registered members</strong>.</p>
          <p class="mt-2">Not a member? <a href="/register" class="text-purple-600 font-semibold underline hover:text-purple-700">Register here</a>.</p>
          <p class="mt-1">Already a member? <a href="/login" class="text-purple-600 font-semibold underline hover:text-purple-700">Login here</a>.</p>
        </div>
      @endif
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">1</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Listen without Judgment</h3>
        <p class="text-gray-700">Create a safe space where the child can share their thoughts and feelings. Let them express grief at their own pace.</p>
      </div>

      <!-- Tip 2 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">2</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Use Age-Appropriate Language</h3>
        <p class="text-gray-700">Talk about the loss in simple terms. Children need honest, gentle explanations about death and what it means for their life.</p>
      </div>

      <!-- Tip 3 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">3</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Reassure Them They Are Safe</h3>
        <p class="text-gray-700">Grief can make children feel anxious or scared. Remind them that they are loved, safe, and cared for. Stability is key to helping them feel secure in uncertain times.</p>
      </div>

      <!-- Tip 4 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">4</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Encourage Creative Expression</h3>
        <p class="text-gray-700">Children may find it easier to express their emotions through drawing, play, or writing. Encourage them to engage in these activities to help process their feelings in a non-verbal way.</p>
      </div>

      <!-- Tip 5 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">5</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Maintain Normal Routines</h3>
        <p class="text-gray-700">Consistency is comforting during times of grief. Try to keep regular meal times, bedtimes, and activities to provide a sense of normalcy amidst the chaos of loss.</p>
      </div>

      <!-- Tip 6 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">6</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Be Patient with Their Grief</h3>
        <p class="text-gray-700">Children may not always express their grief immediately. They may show it in bursts or have moments of joy amid their sadness. Give them the time and space they need to process at their own pace.</p>
      </div>

      <!-- Tip 7 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">7</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Create Rituals of Remembrance</h3>
        <p class="text-gray-700">Help the child find ways to remember the person they lost, such as planting a tree, drawing a picture, or creating a memory box. These rituals offer comfort and help them feel connected to their loved one.</p>
      </div>

      <!-- Tip 8 -->
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition">
        <div class="text-purple-600 font-bold text-2xl mb-2">8</div>
        <h3 class="text-xl font-semibold text-purple-600 mb-2">Encourage Them to Ask Questions</h3>
        <p class="text-gray-700">Grieving children may have many questions. Answer them honestly, but gently. If you don't have all the answers, it's okay to say so, and reassure them that their feelings and questions are valid.</p>
      </div>

    </div>

    <!-- Closing CTA -->
    <div class="mt-12 text-center text-purple-600 rounded-lg bg-yellow-400 text-lg p-6">
      <p>Remember: Grief is unique for every child. Offer love, patience, and support, and consider accessing member programs for additional help.</p>
    </div>
  </div>
</section>
